        ...
        <div>
            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
              ...
              <div>
                ...
                <p className="py-6">
                  {' '}
                  Online voting system is a software platform that allows groups to securely conduct votes and elections.Create an election for your school or organization in seconds. Voters can vote from any location
                </p>
          ...
          <footer className="footer p-10 bg-base-300 text-base-content">
            <div>
              <span className="text-primary footer-title">Vote</span>
              <a className="link link-hover">Branding</a>
              <a className="link link-hover">Voting Plan</a>
              <a className="link link-hover">Awareness</a>
              <a className="link link-hover">Advertisement</a>
            </div>
            <div>
              <span className="footer-title">Online Voting System</span>
